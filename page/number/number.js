...
function Learn(letter){
    ...
    video.src = 'https://github.com/viaasana/tu_luyen_chu_viet_tieng_khmer_nam_bo/blob/main/video/number/'+ letter + '.mp4?raw=true';
    video.autoplay = true;
    video.loop = true;  
...
function playSound(letter){
    ...
    audio.src ='https://github.com/viaasana/tu_luyen_chu_viet_tieng_khmer_nam_bo/blob/main/sound/SO/Recording%20(' + parseFloat(letter  + 75)+ ').m4a?raw=true'
    audio.id = 'audio';
    audio.autoplay = true;
}
