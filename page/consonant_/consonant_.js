...
function createCard(letters){
    for ( i in letters){
        ...
        card.style.backgroundImage = 'url(https://github.com/viaasana/tu_luyen_chu_viet_tieng_khmer_nam_bo/blob/main/image/gui%20chan/'+ i + '.png?raw=true)'
...
function Learn(letter){
    ...
    video.src = 'https://github.com/viaasana/tu_luyen_chu_viet_tieng_khmer_nam_bo/blob/main/video/gui_chan/'+ letter + '.mp4?raw=true';
    video.autoplay = true;
    video.loop = true;  
...
function playSound(letter){
    ...
    audio.src ='https://github.com/viaasana/tu_luyen_chu_viet_tieng_khmer_nam_bo/blob/main/sound/PHU_AM_GUI_CHAN/Recording%20(' + parseFloat(letter  + 85)+ ').m4a?raw=true'
    audio.id = 'audio';
    audio.autoplay = true;
}