...
function createCard(letters){
    for ( i in letters){
        ...
        card.style.backgroundImage = 'url(https://github.com/viaasana/tu_luyen_chu_viet_tieng_khmer_nam_bo/blob/main/image/phu_am/'+ i + '.png?raw=true)'
...
function Learn(letter){
    ...
    video.src = 'https://github.com/viaasana/tu_luyen_chu_viet_tieng_khmer_nam_bo/blob/main/video/vowel_video/'+ letter + '.mp4?raw=true';
    video.autoplay = true;
    video.loop = true;  
...
function playSound(letter){
    ...
    audio.src ='https://github.com/viaasana/tu_luyen_chu_viet_tieng_khmer_nam_bo/blob/main/sound/NGUYEN_AM/Recording%20(' + parseFloat(letter  + 35)+ ').m4a?raw=true'
    audio.id = 'audio';
    audio.autoplay = true;
}