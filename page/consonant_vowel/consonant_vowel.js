...
function createCard(letters){
    for ( i in letters){
        ...
        card.style.backgroundImage = 'url(https://github.com/viaasana/tu_luyen_chu_viet_tieng_khmer_nam_bo/blob/main/image/chong_van/'+ i + '.png?raw=true)'
...
function Learn(letter){
    ...
    video.src = 'https://github.com/viaasana/tu_luyen_chu_viet_tieng_khmer_nam_bo/blob/main/video/chong_van/'+ letter + '.mp4?raw=true';
    video.autoplay = true;
    video.loop = true;  
...
function playSound(letter){
    ...
    audio.src ='https://github.com/viaasana/tu_luyen_chu_viet_tieng_khmer_nam_bo/blob/main/sound/PHU_AM_CHONG_VAN/Recording%20(' + parseFloat(letter  + 93)+ ').m4a?raw=true'
    audio.id = 'audio';
    audio.autoplay = true;
}
